...
const InstallersFormTile: React.FCC<{
  ...
  return (
    <div className={'flex flex-col space-y-6 w-full'}>
      ...
      <div
        className={
          'rounded-lg border border-gray-50 p-2.5 dark:border-dark-800 lg:p-6 shadow-sm max-w-[1000px]'
        }
      >
        {children}
      </div>
...
export default InstallersFormTile;